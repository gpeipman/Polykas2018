...
namespace MediaGallery.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public IActionResult UploadFile(IList<IFormFile> files, int? parentFolder)
        {
            foreach(var file in files)
            {
                ...
                {
                    folder = _dataContext.Folders.First(f => f.Id == parentFolder.Value);
                    parentPath = _galleryContext.GetFolderPath(parentFolder.Value, null);
                }

                var fileName = Path.GetFileName(file.FileName);
                //var filePath = "wwwroot\\gallery\\" + fileName;
